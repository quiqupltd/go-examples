...
import (
	...
	"github.com/quiqupltd/go-code-generation/graph/model"
...
var sources = []*ast.Source{
	{Name: "../spec/graph.gql", Input: `type Query {
...
func (ec *executionContext) field_Mutation_createProduct_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNProductInput2githubᚗcomᚋquiqupltdᚋgoᚑcodeᚑgenerationᚋgraphᚋmodelᚐProductInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createProduct(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNProduct2ᚖgithubᚗcomᚋquiqupltdᚋgoᚑcodeᚑgenerationᚋgraphᚋmodelᚐProduct(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_getAllProducts(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Product)
	fc.Result = res
	return ec.marshalNProduct2ᚕᚖgithubᚗcomᚋquiqupltdᚋgoᚑcodeᚑgenerationᚋgraphᚋmodelᚐProductᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNProduct2githubᚗcomᚋquiqupltdᚋgoᚑcodeᚑgenerationᚋgraphᚋmodelᚐProduct(ctx context.Context, sel ast.SelectionSet, v model.Product) graphql.Marshaler {
	return ec._Product(ctx, sel, &v)
}

func (ec *executionContext) marshalNProduct2ᚕᚖgithubᚗcomᚋquiqupltdᚋgoᚑcodeᚑgenerationᚋgraphᚋmodelᚐProductᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Product) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNProduct2ᚖgithubᚗcomᚋquiqupltdᚋgoᚑcodeᚑgenerationᚋgraphᚋmodelᚐProduct(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNProduct2ᚖgithubᚗcomᚋquiqupltdᚋgoᚑcodeᚑgenerationᚋgraphᚋmodelᚐProduct(ctx context.Context, sel ast.SelectionSet, v *model.Product) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNProductInput2githubᚗcomᚋquiqupltdᚋgoᚑcodeᚑgenerationᚋgraphᚋmodelᚐProductInput(ctx context.Context, v interface{}) (model.ProductInput, error) {
